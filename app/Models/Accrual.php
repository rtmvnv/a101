...
class Accrual extends Model
{
    ...
    public function getOverhaulTextAttribute()
    {
        if (mb_substr($this->account, 0, 5) == '23091') {
            return 'В соответствии с решением общего собрания собственников (Протокол No.1 от 12.04.2023 г.)'
