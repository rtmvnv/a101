    ...
    <table class="table table-hover">
        ...
        <tbody>
            <tr>
                ...
                <td><a href="{{ $day0['not_delivered_link'] }}">{{ $day0['not_delivered'] }}</a></td>
                <td>{{ $day0['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day1['not_delivered_link'] }}">{{ $day1['not_delivered'] }}</a></td>
                <td>{{ $day1['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day2['not_delivered_link'] }}">{{ $day2['not_delivered'] }}</a></td>
                <td>{{ $day2['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day3['not_delivered_link'] }}">{{ $day3['not_delivered'] }}</a></td>
                <td>{{ $day3['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day4['not_delivered_link'] }}">{{ $day4['not_delivered'] }}</a></td>
                <td>{{ $day4['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day5['not_delivered_link'] }}">{{ $day5['not_delivered'] }}</a></td>
                <td>{{ $day5['paid'] }}</td>
            </tr>
            <tr>
                ...
                <td><a href="{{ $day6['not_delivered_link'] }}">{{ $day6['not_delivered'] }}</a></td>
                <td>{{ $day6['paid'] }}</td>
            </tr>
            <tr>
